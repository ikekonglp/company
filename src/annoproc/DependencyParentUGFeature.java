...
public class DependencyParentUGFeature extends BooleanFeature {
	...
	public void initFeature(List<SLAnnotation> annos) {
		...
		System.out
				.println("Finishing building the DependencyParentUGFeature, size is "
	...
	public String[] generateFeatureNames() {
		...
		for(String fn : featureTable.table.keySet()){
			names[featureTable.getIndex(fn)] = "DPUG_" + fn;
		}
		return names;
	}
